...
<i class="bi bi-arrow-left-circle-fill"></i>
  ...
  <div class="Rectangle83" style="width: 1158px; height: 832px; left: 138px; top: 77px; position: absolute; background: #D9D9D9"></div>
   ...
   <div class="form-check">
    ...
    style="width: 202px; height: 32px; left: 69px; top: 8px; position: absolute; color: #6D4B4B; font-size: 40px; font-family: Inter; font-weight: 400; word-wrap: break-word">
  <p><a class="link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover" href="http://localhost/learningphp/desktop1.php"style="color:black" >Pet Connect</a></p></div>
